...
function idTest(){
  ...
  // JS에서 배열 리터럴 표기법 : []
  const colorArray 
    = ['red', "yellow", 'green', '#455ba8', 'black', 'white'];
...
function classTest(){
  ...
  arr[0].style.backgroundColor = "rgb(114,203,80)";
  arr[0].innerText = "arr[0] 입니다";

  arr[1].style.backgroundColor = "rgb(40,255,255)";
  arr[1].innerText = "arr[1] 입니다";

  arr[2].style.backgroundColor = "rgb(150,90,210)";
...
function readValue(){
  ...
  //input에 포커스 맞추기 (한번 입력 후 다시 내용 입력할 수 있게)
  input.focus(); // 요소.focus() : 해당 요소에 포커스 맞추기
}
