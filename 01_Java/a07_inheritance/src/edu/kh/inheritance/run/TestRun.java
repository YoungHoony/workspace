...
//		// console 화면
//		Parent() 기본생성자로 부모 객체 생성
//		Parent(int, String) 매개변수 생성자로 부모 객체 생성
//		--------------------------------------
//		***Parent() 기본생성자로 부모 객체 생성
//		Child1(String) 매개변수 생성자로 자식 객체 생성
//		***Parent() 기본생성자로 부모 객체 생성
//		Child2(String) 매개변수 생성자로 자식 객체 생성
		
		/* 자식이 부모로부터 상속 받은 멤버(필드, 메서드) 사용 */
		
		// 아무리 상속 받았다고 해도 private은 직접 접근이 불가능하다!
		// (부모님의 개인적인 것을 마음대로 건들수 없다.
		// Parent 에 private money 로 필드 작성이 되어있음
		// 상속은 되는데, 직접 접근은 안된다.
		...
		//c1.money = 10; --> 부모의 객체를 직접 접근이 안된다
