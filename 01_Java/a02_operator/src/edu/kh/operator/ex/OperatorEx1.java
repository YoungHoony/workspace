...
public class OperatorEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(); // 줄바꿈 (개행) 한줄 더 내려가게. 
...
//		System.out.printf("%d / %d = %d" , input1, input2, (double)input1 / (double)input2 ); //(double)하나만 해도 자동 형변환이 된다
		
		//[5/2의 결과를 2.5로 나오게 하려면...]
		//input1 또는 input2를 (double)로 강제 형변환 된다. 
		//왜? 
		// (double)input1 / input2 하면 
		// -> double / int -> double  / double 
		//                            (자동 형변환)
		
		
//		System.out.printf("%d / %d = %d" , input1, input2, (double)input1 / input2 ); // %d 때문에 오류가 뜬다
		...
		// % (나머지,modulo) 연산 -> 몫이 정수로 다 나눠진 후 나머지가 출력
		System.out.printf("%d %% %d = %d ", input1 , input2, input1 % input2 );
