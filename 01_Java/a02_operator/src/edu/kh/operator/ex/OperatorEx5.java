...
public class OperatorEx5 {
	...
	public static void main(String[] args) {
		...
		// And 연산자 (&&)
		// - 피연산자 둘 다 true이면 true, 나머진 false 
		...
		System.out.println("num7는 1부터 50사이 정수 이면서 5의 배수가 아닌 수? " + result7);
		
		int num8 = 30;
		boolean result8 = (num8 >= 1 && num8 <= 50) && !(num8 % 5 == 0) ;
		System.out.println("num7는 1부터 50사이 정수 이면서 5의 배수가 아닌 수? " + result8);
