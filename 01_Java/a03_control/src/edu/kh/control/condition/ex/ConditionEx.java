...
public class ConditionEx {
	...
	public void ex2() {
		...
		else {// if 조건식이 false 인 경우 (양수가 아닌 경우) 수행
	...
	// (방법 2) 만약에 String person; 을 하지 않는다면, 각각 print 구문을 적는다. 
		// (방법 3) 만약에 if 을 어린이로 시작한다면 if( age >= 0 && age <=13), 그리고 성인은 ( age <= 100) 
		// else { 
		// person = "잘못 입력"; // 을 맨 뒤로 둘 수 있음
