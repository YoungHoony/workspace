...
public class User {
	...
	// 3. 접근제한자는 상관 없음 (생성자는 대부분 public을 쓴다)
	
	// 매개변수 생성자
	public User(String name, int age) { // 매개변수 갯수가 다름
		this.name = name;
		this.age = age;
	...
	public User(String name, int age, String address) {
		this(age,name); // this() 생성자 : 코드길이 감소가 목적  // 굳이 필요가 있진 않다
