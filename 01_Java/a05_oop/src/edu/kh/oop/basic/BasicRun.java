 ...
 *  		new 연산자에 의해 Heap 메모리 영역에 생성되는 것 
 *  
 *  클래스 (class)란?
...
public class BasicRun {
	...
	public static void main(String [] args) { //실행용 method
		...
		//클래스 == 설계도 == 사용자 정의 자료형
		// Nation n1 : Nation(클래스 이름인데) 객체 참조변수 n1을 선언(주소 저장)
		
		// new : Heap 영역에 새롭게 할당(생성) 
		// new Nation() : Nation 클래스를 이용해서
		//   			  Heap 영역에 Nation 객체를 생성한다. (==메모리를 할당한다)
		// 				  --> 할당된 메모리의 시작 주소가 반환됨
