...
public class PersonService {
	...
	private Scanner sc = new Scanner(System.in);   //System.in =키보드랑 연결한다. 키보드로 입력한 값
	...
	public String getTitle() {
		return title;
		//호출했던 String title = service.getTitle(); 으로 돌아간다. (PersonserviceRun)
	...
	public Person createPerson() {
		...
		char gender = sc.next().charAt(0); //문자열에서 0번째 문자만 반환
