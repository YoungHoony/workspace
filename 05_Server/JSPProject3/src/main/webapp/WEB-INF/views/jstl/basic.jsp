...
<%-- 
  ...
  (참고) 
  URL(Uniform Resource Locator, 통합 자원 경로) : 자원의 위치를 나타내는 문자열 (주소, 경로)
...
<body>
  ...
  <c:set var="test1" value="테스트1" /> <%-- scope 미지정했을 때 == page scope --%>
  ...
  EL : EL로 출력 시 (escapeXml="false") 상태가 적용이 됨 (HTML(마크업 언어) 해석함)
  ${temp}
