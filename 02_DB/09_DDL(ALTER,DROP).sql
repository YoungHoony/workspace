...
DEPT_ID CONSTRAINT SYS_C0014063 NULL; -- DEPT_ID NOT NULL 제거

ALTER TABLE DEPT_COPY MODIFY
DEPT_TITLE CONSTRAINT SYS_C0014064 NULL;

ALTER TABLE DEPT_COPY MODIFY
LOCATION_ID CONSTRAINT SYS_C0014064 NULL;
