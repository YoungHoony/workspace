...
SELECT * FROM DEPARTMENT2;
INSERT INTO DEPARTMENT2 VALUES ('D0', '개발부', 'L1'); -- 1행 삽입
...
(SELECT EMP_ID, EMP_NAME, DEPT_TITLE FROM EMPLOYEE e
...
-- UPDATE, MODIFY, ALTER 는 다 변경하는 것인데, 다 다른곳에서 쓰임
...
-- 업데이트 후 위에 SELECT 수행 --> 결과 확인 후 ROLLBACK;
...
WHEN MATCHED THEN -- 같은 사번이 존재하면 UPDATE하겠다. 
UPDATE SET
