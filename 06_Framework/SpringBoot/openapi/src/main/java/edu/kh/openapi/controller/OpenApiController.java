...
public class OpenApiController {
	...
	//RequestParam : 외부에서 getmapping ex2가 전달될때 같이 전달되는 parameter를 쓰겠다
	...
	public String ex2( Model model, 
		...
		final Map<String, String> coordinateList = new HashMap<>();
	      ...
	      conn.setRequestProperty("Content-type", "application/json"); // 데이터만 보낼거야라는 뜻
	      ...
	      System.out.println(sb.toString()); //문자열 형태
	      ...
	      // item변수에 담긴 JSON 데이터 하나하나를 Map으로 변경한 후 
	      // List에 추가 
