...
public class EditBoardController {
	 ...
	 * @return 
	 */
	@GetMapping("{boardCode:[0-9]+}/{boardNo:[0-9]+}/delete") // 한자리 이상의 코드 
	public String deleteBoard( 
		@PathVariable("boardCode") int boardCode, 
		@PathVariable("boardNo") int boardNo, 
		@SessionAttribute(value="loginMember", required=false /*필수는 아니다*/) Member loginMember,
	...
	public String insertBoard(
			...
			Board board, 
			@RequestParam("images") List<MultipartFile> images, //multipartfile 객체 하나당 파일 1개만 저장가능
			RedirectAttributes ra 
	 ...
	 * @param boardCode : 
	 * @param boardNo :
	 * @param board : 커맨드 객체 (modelattribute가 생략되어서 board 객체 필드에 저장되어있음)
