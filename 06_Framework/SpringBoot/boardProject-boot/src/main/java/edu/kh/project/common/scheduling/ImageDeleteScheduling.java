 ...
 *
 * @Scheduled 속성 (속성을 작성하는 3가지 방법이 있음) 
 ...
 *    
 * * cron 속성 (가장 많이 씀) : UNIX계열 잡 스케쥴러 표현식으로 작성 - cron="초 분 시 일 월 요일 [년도]" - 요일 : 1(SUN) ~ 7(SAT) 
...
@Component // bean 등록 (bean == Sping container가 관리하는 객체) 
@Slf4j
