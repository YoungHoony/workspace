...
public class BoardTypeInterceptor implements HandlerInterceptor {
	...
	// interceptor에서 가장 많이 쓰는 메소드 3가지
	
	// preHandle (전처리) : Dispatcher Servlet <-> Interceptor <-> Controller 사이 
	//						(Controller가 동작하기 전에) 요청을 가로채서 동작 
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		// application scope(서버 실행 시 1개만 생성, 서버 종료 시 사라짐) 
		// 객체 얻어오기
